        ...
        implements JdbcResultSetReader
{
    ...
    public BaseJdbcResultSetReader(TypeManager typeManager)
    {
    ...
    public Object getObject(ResultSet resultSet, int column, Type type) throws Exception
    {
        ...
        if (typeParameters.size() != 1) {
            throw new PrestoException(GENERIC_INTERNAL_ERROR, "Expected one type parameter type, got: " + type.getTypeSignature());
        }
